...
class PyLiveLinkFace:
    ...
    def encode(self) -> bytes:
        ...
        # Limiter à exactement 61 blendshapes
        if len(scaled_blend_shapes) > 61:
            scaled_blend_shapes = scaled_blend_shapes[:61]
